...
machine targets:
  ...
  <machine> test PLAYBOOK="qwerty"  provision and test <machine> with PLAYBOOK
  <machine> debug                   provision and test <machine> then login to container
  <machine> debug PLAYBOOK="qwerty" provision and test <machine> with PLAYBOOK then login to container
